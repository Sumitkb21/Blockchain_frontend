...
import profilelogo from "../Employee/profilelogo.png"
        ...
        <div className="container-fluid my-0">
          <NavLink className="navbar-brand" to="/user/home">
            <div className="logo-cls">
              ...
              <h5 className="logotext" style={{  marginLeft: '10px', marginTop: '5px', background: 'linear-gradient(to right,  #000000 ,#000001)', WebkitBackgroundClip: 'text', color: 'transparent', fontFamily: 'Helvetica Neue' }}> <b> BlockChain </b></h5>
            </div>
          </NavLink>
          <button
